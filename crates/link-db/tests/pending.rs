...
use link_db::pending::{self, CodegenUnit, DefId, ModuleId};
use link_db::LinkDatabase;

#[test]
fn the_placeholder_keys_are_usable() {
    let mut db = LinkDatabase::new();
    let file = db.add_file("a.link", "fn a():\n    1\n");
...
#[test]
#[should_panic(expected = "link-resolve")]
...
#[test]
#[should_panic(expected = "link-regions")]
...
#[test]
#[should_panic(expected = "link-codegen")]
