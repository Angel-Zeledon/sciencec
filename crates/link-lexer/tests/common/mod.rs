...
use link_diagnostics::{Diagnostics, FileId, Severity};
use link_lexer::{lex, NumSuffix, Token, TokenKind};
...
pub fn int(value: u128, base: link_lexer::IntBase, suffix: Option<NumSuffix>) -> TokenKind {
