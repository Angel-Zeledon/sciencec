//! `LINK_BLESS=1` in the environment turns blessing on.
//!
...
//! and assume `LINK_BLESS` is unset.
//!
...
use link_testkit::{run_ui_tests, UiTestOptions};
...
#[test]
fn link_bless_in_the_environment_rewrites_a_stale_expectation() {
